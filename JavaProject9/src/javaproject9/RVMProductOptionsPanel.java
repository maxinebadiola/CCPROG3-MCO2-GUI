 ...
 * @author ERICA
 */
public class RVMProductOptionsPanel extends javax.swing.JPanel {
     ...
     * @param machine
     */
    public RVMProductOptionsPanel(Machine machine) {
    ...
    private void generateProductButtons() {
        ...
        for (int i = 0; i < slotList.size(); i++) { 
            ...
            radioButton.setActionCommand(slotList.get(i).getProduct().getName());
