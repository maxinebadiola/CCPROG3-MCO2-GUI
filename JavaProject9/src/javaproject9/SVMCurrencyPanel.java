 ...
 * @author ERICA
 */
public class SVMCurrencyPanel extends javax.swing.JPanel {
     ...
     * @param special
     */
    public SVMCurrencyPanel(Special special) {
    ...
    private void generatePaymentButtons() {
        ArrayList<Currency> currencyStock = special.getCurrencyStock();
    ...
    public void resetCountLabels() {
        ...
        for (Component component : jPanel1.getComponents()) {
            if (component instanceof JPanel jPanel) {
                for (Component subComponent : jPanel.getComponents()) {
