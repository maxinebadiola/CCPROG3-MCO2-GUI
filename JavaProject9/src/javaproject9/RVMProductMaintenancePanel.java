 ...
 * @author ERICA
 */
public class RVMProductMaintenancePanel extends javax.swing.JPanel {

    private Machine machine;
    private RVMProductOptionsPanel productsPanel;
    private RVMPrintProductPanel printProductPanel;

    public RVMProductMaintenancePanel(Machine machine) {
    ...
    private void confirmRestockSlotButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_confirmButton1ActionPerformed
        ...
        RVMProductOptionsPanel productsPanel = (RVMProductOptionsPanel) container1.getComponent(0);
    ...
    private void confirmEditPriceButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_confirmButton3ActionPerformed
        RVMProductOptionsPanel productsPanel = (RVMProductOptionsPanel) container3.getComponent(0);
        String selectedProduct = productsPanel.getSelectedProduct();
    ...
    private void performRestock(String selectedProduct, int stock) {
        int slotIndex = machine.findSlotIndexByProduct(selectedProduct);
        try {
    ...
    private void initializeProductsPanel(Machine machine) {
        ...
        productsPanel = new RVMProductOptionsPanel(machine);
    ...
    private void initializePrintProductPanel(Machine machine) {
        ...
        printProductPanel = new RVMPrintProductPanel(machine);
